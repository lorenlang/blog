<a target="_blank" title="Share on Twitter" href="{{ url('share/' . $post->id . '/twitter') }}"><i class="share-icon-twitter"></i></a>
<a target="_blank" title="Share on Facebook" href="{{ url('share/' . $post->id . '/facebook') }}"><i class="share-icon-facebook"></i></a>
<a target="_blank" title="Share on Google+" href="{{ url('share/' . $post->id . '/google-plus') }}"><i class="share-icon-google-plus"></i></a>
<a target="_blank" title="Share on StumbleUpon" href="{{ url('share/' . $post->id . '/stumbleupon') }}"><i class="share-icon-stumbleupon"></i></a>
<a target="_blank" title="Share on LinkedIn" href="{{ url('share/' . $post->id . '/linkedin') }}"><i class="share-icon-linkedin"></i></a>
<a target="_blank" title="Share on Reddit" href="{{ url('share/' . $post->id . '/reddit') }}"><i class="share-icon-reddit"></i></a>
<a target="_blank" title="Share by Email" href="{{ url('share/' . $post->id . '/email') }}"><i class="share-icon-email"></i></a>
